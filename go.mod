...
require (
	...
	github.com/red-hat-storage/ocs-operator/v4 v4.0.0-20231017153905-2f69d254d5c9
...
require (
	...
	github.com/rook/rook/pkg/apis v0.0.0-20230803134004-99ba8cd6b647 // indirect
