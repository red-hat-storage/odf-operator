...
ODF_DEPS_SUBSCRIPTION_STARTINGCSV ?= $(ODF_DEPS_SUBSCRIPTION_PACKAGE).v$(VERSION)
...
OCS_SUBSCRIPTION_STARTINGCSV ?= $(OCS_SUBSCRIPTION_PACKAGE).$(OCS_BUNDLE_VERSION)
...
OCS_CLIENT_SUBSCRIPTION_STARTINGCSV ?= $(OCS_CLIENT_SUBSCRIPTION_PACKAGE).$(OCS_CLIENT_BUNDLE_VERSION)
...
ROOK_SUBSCRIPTION_STARTINGCSV ?= $(ROOK_SUBSCRIPTION_PACKAGE).$(ROOK_BUNDLE_VERSION)
...
NOOBAA_SUBSCRIPTION_STARTINGCSV ?= $(NOOBAA_SUBSCRIPTION_PACKAGE).$(NOOBAA_BUNDLE_VERSION)
...
CEPHCSI_SUBSCRIPTION_STARTINGCSV ?= $(CEPHCSI_SUBSCRIPTION_PACKAGE).$(CEPHCSI_BUNDLE_VERSION)
...
CSIADDONS_SUBSCRIPTION_STARTINGCSV ?= $(CSIADDONS_SUBSCRIPTION_PACKAGE).$(CSIADDONS_BUNDLE_VERSION)
...
PROMETHEUS_SUBSCRIPTION_STARTINGCSV ?= $(PROMETHEUS_SUBSCRIPTION_PACKAGE).$(PROMETHEUS_BUNDLE_VERSION)
...
RECIPE_SUBSCRIPTION_STARTINGCSV ?= $(RECIPE_SUBSCRIPTION_PACKAGE).$(RECIPE_BUNDLE_VERSION)
...
IBM_SUBSCRIPTION_STARTINGCSV ?= $(IBM_SUBSCRIPTION_PACKAGE).$(IBM_BUNDLE_VERSION)
