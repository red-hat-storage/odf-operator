...
DEVICEFINDER_IMAGE_NAME ?= devicefinder
...
UX_BACKEND_OAUTH_IMAGE ?= quay.io/openshift/origin-oauth-proxy:5.0.0
...
OCS_TLS_BUNDLE_IMG ?= quay.io/ocs-dev/ocs-tls-profiles-bundle:main-0c5f6d8
OCS_TLS_BUNDLE_VERSION ?= v5.0.0
OCS_TLS_SUBSCRIPTION_PACKAGE ?= ocs-tls-profiles
OCS_TLS_SUBSCRIPTION_CHANNEL ?= alpha
OCS_TLS_SUBSCRIPTION_CSVNAME ?= $(OCS_TLS_SUBSCRIPTION_PACKAGE).$(OCS_TLS_BUNDLE_VERSION)

OCS_BUNDLE_IMG ?= quay.io/ocs-dev/ocs-operator-bundle:release-5.0-ad9d272
OCS_BUNDLE_VERSION ?= v5.0.0
...
OCS_CLIENT_BUNDLE_IMG ?= quay.io/ocs-dev/ocs-client-operator-bundle:main-9834eff
OCS_CLIENT_BUNDLE_VERSION ?= v5.0.0
...
ROOK_BUNDLE_IMG ?= quay.io/ocs-dev/rook-ceph-operator-bundle:master-855ce45bb
ROOK_BUNDLE_VERSION ?= v5.0.0
...
NOOBAA_BUNDLE_IMG ?= quay.io/noobaa/noobaa-operator-bundle:master-20260820
NOOBAA_BUNDLE_VERSION ?= v5.23.0
...
CEPHCSI_BUNDLE_IMG ?= quay.io/ocs-dev/cephcsi-operator-bundle:main-fb44aa5
CEPHCSI_BUNDLE_VERSION ?= v5.0.0
...
ODF_SNAPSHOT_CONTROLLER_BUNDLE_IMG ?= quay.io/ocs-dev/snapshot-controller-bundle:main-26525d9
ODF_SNAPSHOT_CONTROLLER_BUNDLE_VERSION ?= v5.0.0
...
PROMETHEUS_BUNDLE_IMG ?= quay.io/ocs-dev/odf-prometheus-operator-bundle:main-99f1297
PROMETHEUS_BUNDLE_VERSION ?= v5.0.0
...
IBM_ODF_BUNDLE_VERSION ?= v1.9.0
IBM_ODF_SUBSCRIPTION_PACKAGE ?= ibm-storage-odf-operator
IBM_ODF_SUBSCRIPTION_CHANNEL ?= stable-v1.9
...
IBM_CSI_BUNDLE_VERSION ?= v1.13.2
IBM_CSI_SUBSCRIPTION_PACKAGE ?= ibm-block-csi-operator
IBM_CSI_SUBSCRIPTION_CHANNEL ?= stable-1.13.2
IBM_CSI_SUBSCRIPTION_CSVNAME ?= $(IBM_CSI_SUBSCRIPTION_PACKAGE).$(IBM_CSI_BUNDLE_VERSION)

CNSA_BUNDLE_IMG ?= preprod.icr.io/cpopen/ibm-spectrum-scale-operator-bundle:v6.0.2.0_latest
CNSA_BUNDLE_VERSION ?= v60.2.0
CNSA_SUBSCRIPTION_PACKAGE ?= ibm-spectrum-scale-operator
CNSA_SUBSCRIPTION_CHANNEL ?= stable-v60.2
