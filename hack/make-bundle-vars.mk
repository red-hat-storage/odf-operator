...
NOOBAA_BUNDLE_IMG_TAG ?= v5.13.0
NOOBAA_BUNDLE_IMG_LOCATION ?= docker.io/noobaa
...
CSIADDONS_BUNDLE_IMG_TAG ?= v0.6.0
...
STARTING_CSVS ?= "$(IMAGE_NAME).v$(VERSION) $(OCS_SUBSCRIPTION_STARTINGCSV) $(NOOBAA_SUBSCRIPTION_STARTINGCSV) $(CSIADDONS_SUBSCRIPTION_STARTINGCSV)"
