...
CSV_NAMES ?= "$(IMAGE_NAME).v$(VERSION) $(ODF_DEPS_SUBSCRIPTION_CSVNAME) $(OCS_SUBSCRIPTION_CSVNAME) $(ROOK_SUBSCRIPTION_CSVNAME) \
			$(NOOBAA_SUBSCRIPTION_CSVNAME) $(CSIADDONS_SUBSCRIPTION_CSVNAME) $(CEPHCSI_SUBSCRIPTION_CSVNAME) \
			$(OCS_CLIENT_SUBSCRIPTION_CSVNAME) $(PROMETHEUS_SUBSCRIPTION_CSVNAME) $(RECIPE_SUBSCRIPTION_CSVNAME)"
