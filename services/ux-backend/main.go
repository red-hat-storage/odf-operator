...
import (
	...
	registrychecks "github.com/red-hat-storage/odf-operator/services/ux-backend/handlers/cnsa/registry-checks"
	...
	"github.com/red-hat-storage/odf-operator/services/ux-backend/handlers/storages"
...
func main() {
	...
	if err := cache.IndexField(ctx, &nbv1a1.ObjectBucket{}, util.IndexBucketName, func(obj client.Object) []string {
