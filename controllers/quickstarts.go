...
func (r *StorageSystemReconciler) deleteQuickStarts(instance *odfv1alpha1.StorageSystem, logger logr.Logger) {
	if len(AllQuickStarts) == 0 {
		logger.Info("No quickstarts found.")
	}

	allSSDeleted, err := r.areAllStorageSystemsMarkedForDeletion(instance.Spec.Namespace)
	if err != nil {
