...
type MultiCloudGateway struct {
	...
	Spec   MultiCloudGatewaySpec   `json:"spec,omitempty"`
	Status MultiCloudGatewayStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// MultiCloudGatewayList contains a list of MultiCloudGateway
type MultiCloudGatewayList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MultiCloudGateway `json:"items"`
}

func init() {
	SchemeBuilder.Register(&MultiCloudGateway{}, &MultiCloudGatewayList{})
}
